...
namespace {
	...
	*/
	...
	static map<block_face, vector<vertex>> cw_face_map = {
		{Front, {
			{vec3(-0.5, 0.5, 0.5),  vec2(0.0, 1.0), vec3(0.0, 0.0, 1.0)},
			{vec3(0.5, 0.5, 0.5),	vec2(1.0, 1.0), vec3(0.0, 0.0, 1.0)},
			{vec3(0.5, -0.5, 0.5),	vec2(1.0, 0.0), vec3(0.0, 0.0, 1.0)},
			{vec3(-0.5,-0.5, 0.5),	vec2(0.0, 0.0), vec3(0.0, 0.0, 1.0)},
		}},
		{Back, {
			{vec3(0.5, 0.5, -0.5) ,	vec2(0.0, 1.0), vec3(0.0, 0.0, -1.0)},
			{vec3(-0.5, 0.5,-0.5),	vec2(1.0, 1.0), vec3(0.0, 0.0, -1.0)},
		...
		{Right, {
			{vec3(0.5, 0.5, 0.5),	vec2(0.0, 1.0), vec3(1.0, 0.0, 0.0)},
			{vec3(0.5, 0.5, -0.5),	vec2(1.0, 1.0), vec3(1.0, 0.0, 0.0)},
			{vec3(0.5,-0.5, -0.5),	vec2(1.0, 0.0), vec3(1.0, 0.0, 0.0)},
			{vec3(0.5, -0.5, 0.5),	vec2(0.0, 0.0), vec3(1.0, 0.0, 0.0)},
		}},
		{Left, {
			{vec3(-0.5, 0.5, -0.5),	vec2(0.0, 1.0), vec3(-1.0, 0.0, 0.0)},
			{vec3(-0.5, 0.5, 0.5),	vec2(1.0, 1.0), vec3(-1.0, 0.0, 0.0)},
		...
		{Top, {
			{vec3(-0.5, 0.5,-0.5),	vec2(0.0, 1.0), vec3(0.0, 1.0, 0.0)},
			{vec3(0.5, 0.5, -0.5),	vec2(1.0, 1.0), vec3(0.0, 1.0, 0.0)},
			{vec3(0.5, 0.5, 0.5),	vec2(1.0, 0.0), vec3(0.0, 1.0, 0.0)},
			{vec3(-0.5, 0.5, 0.5),	vec2(0.0, 0.0), vec3(0.0, 1.0, 0.0)},
		}},
		{Bottom, {
			{vec3(0.5, -0.5, -0.5), vec2(0.0, 1.0), vec3(0.0, -1.0, 0.0)},
			{vec3(-0.5,-0.5,-0.5),	vec2(1.0, 1.0), vec3(0.0, -1.0, 0.0)},
