...
namespace {
	...
	*/
	const BiomeDefinition table[(int)biome_id::count] = {
		//               id                         name          surface     subsurf depth grass tint                   foliage tint                 tree cover flower  flower type
		{ biome_id::ocean,        "ocean",        sand,       sand,   4, vec3(0.35f,0.58f,0.36f), vec3(0.30f,0.52f,0.30f),   0,   0,   0, flower_white  },
		{ biome_id::beach,        "beach",        sand,       sand,   5, vec3(0.50f,0.72f,0.37f), vec3(0.42f,0.64f,0.30f),   0,  60,   0, flower_white  },
		{ biome_id::desert,       "desert",       sand,       sand,   6, vec3(0.74f,0.71f,0.33f), vec3(0.66f,0.63f,0.28f),   0, 140, 260, flower_yellow },
		{ biome_id::plains,       "plains",       dirt_grass, dirt,   4, vec3(0.57f,0.79f,0.33f), vec3(0.47f,0.70f,0.27f), 140,   9,  22, flower_yellow },
		{ biome_id::savanna,      "savanna",      dirt_grass, dirt,   4, vec3(0.74f,0.72f,0.30f), vec3(0.80f,0.68f,0.18f),  70,  12,  34, flower_yellow },
		{ biome_id::forest,       "forest",       dirt_grass, dirt,   4, vec3(0.42f,0.71f,0.29f), vec3(0.30f,0.60f,0.22f),  14,   7,  30, flower_white  },
		{ biome_id::autumn_forest,"autumn forest",dirt_grass, dirt,   4, vec3(0.55f,0.62f,0.26f), vec3(0.78f,0.33f,0.12f),  14,   8,  26, flower_red    },
		{ biome_id::swamp,        "swamp",        dirt_grass, dirt,   4, vec3(0.42f,0.55f,0.27f), vec3(0.36f,0.48f,0.22f),  38,   5,  70, flower_purple },
		{ biome_id::taiga,        "taiga",        dirt_grass, dirt,   4, vec3(0.34f,0.58f,0.40f), vec3(0.24f,0.44f,0.32f),  18,  14,  90, flower_purple },
