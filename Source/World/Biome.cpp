...
namespace {
	...
	*/
	const BiomeDefinition table[(int)biome_id::count] = {
		//                id                    name          surface      subsurface  depth  grass tint                    foliage tint                  tree  cover
		{ biome_id::ocean,      "ocean",      sand,       sand,   4, vec3(0.35f, 0.58f, 0.36f), vec3(0.30f, 0.52f, 0.30f),   0,   0 },
		{ biome_id::beach,      "beach",      sand,       sand,   5, vec3(0.50f, 0.72f, 0.37f), vec3(0.42f, 0.64f, 0.30f),   0,  60 },
		{ biome_id::desert,     "desert",     sand,       sand,   6, vec3(0.74f, 0.71f, 0.33f), vec3(0.66f, 0.63f, 0.28f),   0, 140 },
		{ biome_id::plains,     "plains",     dirt_grass, dirt,   4, vec3(0.57f, 0.79f, 0.33f), vec3(0.47f, 0.70f, 0.27f), 140,   9 },
		{ biome_id::forest,     "forest",     dirt_grass, dirt,   4, vec3(0.42f, 0.71f, 0.29f), vec3(0.30f, 0.60f, 0.22f),  14,   7 },
		{ biome_id::swamp,      "swamp",      dirt_grass, dirt,   4, vec3(0.42f, 0.55f, 0.27f), vec3(0.36f, 0.48f, 0.22f),  38,   5 },
		{ biome_id::taiga,      "taiga",      dirt_grass, dirt,   4, vec3(0.34f, 0.58f, 0.40f), vec3(0.26f, 0.48f, 0.34f),  18,  14 },
		{ biome_id::tundra,     "tundra",     snow,       dirt,   4, vec3(0.50f, 0.62f, 0.50f), vec3(0.42f, 0.55f, 0.45f), 220,  40 },
		{ biome_id::mountain,   "mountain",   stone,      stone,  6, vec3(0.45f, 0.65f, 0.38f), vec3(0.38f, 0.56f, 0.32f), 300,  60 },
		{ biome_id::snowy_peak, "snowy peak", snow,       stone,  5, vec3(0.55f, 0.66f, 0.58f), vec3(0.48f, 0.58f, 0.52f),   0,   0 },
	};
}
